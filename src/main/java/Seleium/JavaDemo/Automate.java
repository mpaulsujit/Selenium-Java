...
public class Automate {
	...
	WebDriver driver=Library.launchChrome("https://www.mortgagecalculator.org/");
		...
		String mPay=monthlyPayment.getText();//how do I know the name the method name monthlyPayment (Mritynjay??
		System.out.println("Your monthly payment is: "+mPay);
		
		
		WebElement pmir=driver.findElement(By.xpath("(//div[@class='repayment-block']//h3)[2]/.."));
		String pMi=pmir.getText();// How do I know the method name of pmi?
		System.out.println("Your PMI is: "+pMi);
		
		WebElement downPayment=driver.findElement(By.xpath("//div[@class='repayment-block']//h3)[3]"));
		String mPay=monthlyPayment.getText();//how do I know the name the method name monthlyPayment (Mritynjay??
		System.out.println("Your monthly payment is: "+mPay);
